...
func GetNoteHandlerFromId(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	k := vars["id"]
	...
	if _, ok := noteStore[k]; ok {
		...
		log.Printf("Could not find key of Note %s to get", k)
...
func main() {
	...
	r.HandleFunc("/api/notes/{id}", GetNoteHandlerFromId).Methods("GET") 
